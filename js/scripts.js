...
const years = [
 ...
 { year: "Tim Berners-Lee", description: "conocido por ser el padre de la World Wide Web. Estableció la primera comunicación entre un cliente y un servidor usando el protocolo HTTP en diciembre de 1980.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/Sir_Tim_Berners-Lee_(cropped).jpg/220px-Sir_Tim_Berners-Lee_(cropped).jpg" },
{ year: "Jennifer Doudna", description: "bioquímica estadounidense, catedrática de Química y Biología celular y molecular en la Universidad de California, Berkeley, codesarrolló el CRISPR (Clustered Regularly Interspaced Short Palindromic Repeats), un modificador de ADN", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/41/Professor_Jennifer_Doudna_ForMemRS_(cropped).jpg/220px-Professor_Jennifer_Doudna_ForMemRS_(cropped).jpg" },
